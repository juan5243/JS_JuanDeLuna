...
// Asigna la velocidad de la Snake B)
let velocity = 20;
...
function game() {
    ...
    // Termina el juego y se crea un alert para reiniciar o terminar el juego 
...
// Asigna los movimientos a las teclas del Teclado 
let d = "";
